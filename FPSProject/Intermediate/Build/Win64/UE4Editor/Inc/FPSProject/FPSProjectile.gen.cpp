...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_AFPSProjectile_OnHit()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				...
				{ "ToolTip", "Function called when projectile hits something." },
			};
#endif
	...
	UClass* Z_Construct_UClass_AFPSProjectile()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_AFPSProjectile_OnHit, "OnHit" }, // 2441403752
			};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AFPSProjectile, 1765469101);
