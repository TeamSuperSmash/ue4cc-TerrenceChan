...
#define FPSProject_Source_FPSProject_FPSCharacter_h_12_RPC_WRAPPERS \
 \
	DECLARE_FUNCTION(execSetPitchSensitivity) \
	{ \
		P_GET_PROPERTY(UFloatProperty,Z_Param_value); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->SetPitchSensitivity(Z_Param_value); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSetYawSensitivity) \
	{ \
		P_GET_PROPERTY(UFloatProperty,Z_Param_value); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->SetYawSensitivity(Z_Param_value); \
		P_NATIVE_END; \
	} \
 \
